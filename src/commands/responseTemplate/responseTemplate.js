...
const responseTemplate = {
  ...
  help: `▎📝 Регистрация \
\n \nДля регистрации нажмите на команду /registration и поделитесь вашим номером телефона. Руководитель свяжется с вами в течение 15 минут.  \
\n \nДля быстрой регистрации вы можете позвонить по телефону: 8 903 971 8590.\
\n \n---\
\n \n▎📄 Оформление заявки\
\n \nВ меню выберите команду /orders. Заявка оформляется в формате вопрос-ответ, некоторые пункты можно выбрать из предложенных вариантов или пропустить. \ 
\n \nМенеджер начнет работу с вашей заявкой в течение 15 минут.\
\n \n---\
\n \n▎💬 Отслеживание статуса заявки\
\n \nВ автоматическом режиме вам будет приходить информация о статусе заявки:\
\n \n• В работе (менеджер связывается с клиентом и предлагает услуги)\
\n \n• Предоплата получена (клиент оплатил мероприятие)\
\n \n• Завершена (мероприятие прошло, запрошен отзыв о мероприятии, формируется отчетная часть)\
\n \n• Отказ (после отказа и проверки куратор направит причину отказа через бота)\
\n \n---\
\n \n▎📄 Работа с заявками (уточнение статуса и вопросы)\
\n \n1. Выберите из меню команду /chats, запросите статус по предложенной кнопке. \ 
\n \n2. Если у вас остались вопросы, перейдите по кнопке заказа во внутренний чат и напишите свой вопрос. Менеджер ответит вам в течение 15 минут.\
\n \n---\
\n \n▎🌅 Отчетность\
\n \n• Чек: после завершения заказа куратор вышлет чек через бота.\
\n \n• Отзыв: вам будет выслан скриншот отзыва о проведенном мероприятии.\
\n \n---\
\n \n▎⚙️ Другие команды\
\n \n• /start – описание бота\
\n \n• /clear – сбросить этап заполнения заявки и выйти из текущего чата\
\n \n---\
\n \nПо всем вопросам также можно написать администратору \
 \n \n@mercyboky или позвонить по телефону +7 903 971 8590`,
